...
const LoginForm = () =>{
  ...
  */
  ...
  const onSignIn = (e) =>{
    ...
    e.preventDefault()
    axios.post('http://localhost:8081/login',signInData) //{username:'deepthi',password:12345,mobile:12113123})
    .then(res=>{
  ...
  const onSignUp = (e) =>{
    ...
    axios.post('http://localhost:8081/data',signUpData) //{username:'deepthi',password:12345,mobile:12113123})
    .then(res=>{
